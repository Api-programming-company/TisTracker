...
CREATE TABLE system.academic_periods (
    ...
    created_at timestamp(0) without time zone,
    updated_at timestamp(0) without time zone,
    company_creation_start_date date,
    company_creation_end_date date,
...
COPY system.academic_periods (id, name, start_date, end_date, description, user_id, created_at, updated_at, company_creation_start_date, company_creation_end_date, planning_start_date, planning_end_date) FROM stdin;
\.
...
22	2024_11_30_033123_add_dates_to_academic_periods_table	1
\.
...
SELECT pg_catalog.setval('system.migrations_id_seq', 22, true);
