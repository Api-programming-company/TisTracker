...
export const planningSlice = createSlice({
    ...
    reducers : {
        ...
        changeDeliverable: (state,action) => {
            ...
            const milestoneIndex = currentMilestones.findIndex((milestone) => milestone.id === milestone_id);
            const deliverableIndex = currentMilestones[milestoneIndex].deliverables.findIndex((deliverable) => deliverable.id === id);

            const numberValue = Number(value);
            const numberHopeResult = Number(currentMilestones[milestoneIndex].deliverables[deliverableIndex].hopeResult);
            ...
            return {
                    ...
                    ...currentMilestones.slice(0, milestoneIndex),
                {
                    ...
                    deliverables: [
                        ...currentMilestones[milestoneIndex].deliverables.slice(0, deliverableIndex),
                        {
                            ...currentMilestones[milestoneIndex].deliverables[deliverableIndex],
                            [field]: value
                        },
                        ...currentMilestones[milestoneIndex].deliverables.slice(deliverableIndex + 1),
                    ]
                },
