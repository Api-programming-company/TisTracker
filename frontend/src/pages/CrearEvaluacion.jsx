...
const RegistroGE = () => {
    ...
    useEffect(() => {
        if (academicPeriodData) {
            console.log(academicPeriodData);
            console.log(
                academicPeriodData.academic_period.evaluation_start_date
            );
            console.log(academicPeriodData.academic_period.evaluation_end_date);
        }
    }, [academicPeriodData]);
    ...
    if (isFetching || isCreatingEvaluation || isAcademicPeriodLoading) {
        return (
            <Container
                maxWidth="sm"
                sx={{
